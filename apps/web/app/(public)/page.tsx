...
function ArticleCard({ a }: { a: Article }) {
  ...
  const externalImg = getPreferredArticleImage(a) ?? getBodyImageUrl(a.body);
  const imgSrc = imgError ? LOGO_FALLBACK : getArticleImage(a.slug, undefined, 'thumb', externalImg);
  return (
